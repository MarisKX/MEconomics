  ...
  <div class="government">
    ...
    <div class="main">
      ...
      <AddGovernmentModal
        :isVisible="showModal"
        @close="toggleModal"
        @companyAdded="handleGovernmentInstitutionAdded"
...
export default {
  ...
  methods: {
    ...
    handleGovernmentInstitutionAdded(governmentInstitution) {
      this.governmentInstitutions.push(governmentInstitution);
    },
  },
};
</script>
